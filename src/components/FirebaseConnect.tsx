...
export function FirebaseConnect({ config, configJson, onConfigChange, onConfigJsonChange, onSubmit }: FirebaseConnectProps) {
  ...
  return (
    <div className="bg-white dark:bg-dark-800 rounded-lg shadow p-6">
      <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Connect to Firebase</h2>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              <textarea
                value={configJson}
                className="w-full h-32 px-3 py-2 border border-gray-300 dark:border-dark-600 rounded-md mb-4 bg-white dark:bg-dark-900 text-gray-900 dark:text-white"
